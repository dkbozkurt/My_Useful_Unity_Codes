...
public class Trajectory_Cannon : MonoBehaviour
{
    [SerializeField] private Trajectory_Projection _projection;
    ...
    [SerializeField] private Trajectory_Ball _ballPrefab;

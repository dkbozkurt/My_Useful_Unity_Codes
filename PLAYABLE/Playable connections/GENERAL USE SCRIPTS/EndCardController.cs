...
namespace CpiTemplate.Game.Playable.Scripts.PlayableConnections
{
    ...
    public class EndCardController : SingletonBehaviour<EndCardController>
    {
        ...
        [SerializeField] private Image _endCardBackground;
        [SerializeField] private Image _endCardIcon;
        [SerializeField] private Image _endCardText;
        [SerializeField] private Image _endCardPlayButton;
        ...
        {
            var obj = GameObject.Find("Tutorial");

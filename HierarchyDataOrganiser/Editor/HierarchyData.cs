...
namespace HierarchyDataOrganiser.Editor
{
    /// <summary>
    /// Ref : https://github.com/febucci/unitypackage-custom-hierarchy/releases/
    /// Ref : https://www.youtube.com/watch?v=Gma7IXPj4wI&list=RDCMUCfIiEKtakOPRPnE4iQTLvlA&start_radio=1&ab_channel=CocoCode 
    /// </summary>
    [CreateAssetMenu(menuName = "HierarchyDataOrganizer")]
    public class HierarchyData : ScriptableObject
    {
        ...
        public bool drawActivationToggle = false;

...
namespace FreeDraw
{
    ...
    public class Drawable : MonoBehaviour
    {
        ...
        // Added for playable
        public bool resetTextureOnPlay = true;
        public Texture2D resetTexture;
        private Color[] cleanTextureArray;
...
//////////////////////////////////////////////////////////////////////////////
        ...
        void Update()
        {
            ...
            if (mouse_held_down && !no_drawing_on_current_drag)
            {
                ...
                if (hit != null && hit.transform != null)
                {
                    ...
                    // Paint the mouse position with offset value
                    //current_brush(mouse_world_position + offsetValue);

                    // Paint the object position
                    current_brush(drawObject.transform.position);
                }
        ...
        {
            clean_colours_array = resetTexture.GetPixels();
            
            drawable_texture.SetPixels(cleanTextureArray);
            drawable_texture.Apply();
        }
